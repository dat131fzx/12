...
package.domain = com.example.wallpaperchanger
...
requirements = python3,kivy,pyjnius,android,requests,urllib3,certifi,charset-normalizer,idna
...
# 1) android.add_assets = file1.txt,image.png,audio.wav,dir
# 2) android.add_assets.1 = path/to/file1.txt
#    android.add_assets.2 = path/to/dir2
#    android.add_assets.3 = path/to/dir3/file3.txt
#android.add_assets =
...
# Get a list of available identities: ios.codesign.debug = "iPhone Developer: <lastname> <firstname> (<hexstring>)"
